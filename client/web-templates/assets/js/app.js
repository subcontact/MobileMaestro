define(["angular", "controllers/QuizMainChoiceController", "directives/directives", "services/QuizServices"], function(angular){
	return angular.module('main', ['QuizServices', 'QuizMainChoiceController','directives']).config(function($provide){
